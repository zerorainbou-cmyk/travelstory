...
/**
 * Class OVABRW_Product_Short_Description
 */
if ( !class_exists( 'OVABRW_Product_Short_Description', false ) ) {

	class OVABRW_Product_Short_Description extends \Elementor\Widget_Base {
	...
	// Regiser new widget
	$widgets_manager->register( new OVABRW_Product_Short_Description() );
}