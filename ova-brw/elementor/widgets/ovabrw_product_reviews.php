...
/**
 * Class OVABRW_Product_Reviews
 */
if ( !class_exists( 'OVABRW_Product_Reviews', false ) ) {

	class OVABRW_Product_Reviews extends \Elementor\Widget_Base {
		...
		protected function render() {
			...
			<div class="elementor-ovabrw-product-reviews">
				<?php wc_get_template( apply_filters( OVABRW_PREFIX.'element_product_review_template' ,'rental/loop/review.php' ), [
					'id' => $product->get_id()
				]); ?>
			</div>
			<?php
	...
	// Regiser new widget
	$widgets_manager->register( new OVABRW_Product_Reviews() );
}