...
/**
 * Class OVABRW_Product_Plan
 */
if ( !class_exists( 'OVABRW_Product_Plan', false ) ) {

	class OVABRW_Product_Plan extends \Elementor\Widget_Base {

		/**
		 * Get widget name
		 */
		public function get_name() {		
			return 'ovabrw_product_plan';
		}
		...
		public function get_title() {
			return esc_html__( 'Product Plan', 'ova-brw' );
		}
		...
		public function get_script_depends() {
			return [ 'ovabrw-elementor-product-plan' ];
		}
			...
			$this->start_controls_section(
			    ...
			    $this->add_control(
					...
					[
						...
						'raw' 	=> esc_html__( "Don't enter Product ID if you use this element in templates for product detail page.In Elementor Preview ( When empty Product ID ) , this element display an example product plan of the latest product", 'ova-brw' ),
			...
			$this->start_controls_section(
				...
				$this->add_control(
					...
					[
						...
						'selectors' => [
							'{{WRAPPER}} .elementor-ovabrw-product-plan .content-product-item' => 'color: {{VALUE}};',
						],
					]
				);
				...
				$this->add_control(
					...
					[
						...
						'type' 	 	=> \Elementor\Controls_Manager::COLOR,
						'selectors' => [
							'{{WRAPPER}} .elementor-ovabrw-product-plan .content-product-item h2' => 'color: {{VALUE}};',
						],
					]
				);
		...
		protected function render() {
			...
			<div class="elementor-ovabrw-product-plan">
				<?php wc_get_template( apply_filters( OVABRW_PREFIX.'element_product_plan_template' ,'rental/loop/plan.php' ), [
					'id' => $product->get_id()
				]); ?>
			</div>
			<?php
	...
	// Regiser new widget
	$widgets_manager->register( new OVABRW_Product_Plan() );
}