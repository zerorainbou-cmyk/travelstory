...
/**
 * Class OVABRW_Search_Ajax
 */
if ( !class_exists( 'OVABRW_Search_Ajax', false ) ) {

	class OVABRW_Search_Ajax extends \Elementor\Widget_Base {
		...
		public function get_title() {
			return esc_html__( 'Tour Search Ajax', 'ova-brw' );
		}
		...
		public function get_script_depends() {
			return [ 'ovabrw-jquery-ui', 'ovabrw-jquery-ui-touch', 'ovabrw-elementor-product-search', 'ovabrw-elementor-product-search-ajax' ];
		}
		...
		protected function render() {
			...
			// Get template
			ovabrw_get_template( apply_filters( OVABRW_PREFIX.'element_product_search_ajax_template' ,'single/search_ajax.php' ), $settings );
		}
	}

	// Regiser new widget
	$widgets_manager->register( new OVABRW_Search_Ajax() );
}