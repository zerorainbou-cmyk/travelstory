...
/**
 * Class OVABRW_Product_Included_Excluded
 */
if ( !class_exists( 'OVABRW_Product_Included_Excluded', false ) ) {

	class OVABRW_Product_Included_Excluded extends \Elementor\Widget_Base {
		...
		protected function render() {
			...
			<div class="elementor-ovabrw-product-included-excluded">
				<?php wc_get_template( apply_filters( OVABRW_PREFIX.'element_product_included_excluded_template', 'rental/loop/included-excluded.php' ), [
					'id' => $product->get_id()
				]); ?>
			</div>
			<?php
	...
	// Regiser new widget
	$widgets_manager->register( new OVABRW_Product_Included_Excluded() );
}