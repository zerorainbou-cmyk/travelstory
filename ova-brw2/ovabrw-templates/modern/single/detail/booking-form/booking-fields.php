...
?>
	...
	<div class="rental_item form-location-field">
		<label for="<?php echo esc_attr( $product->get_meta_key( 'pickup_location' ) ); ?>">
			<?php esc_html_e( 'Pick-up Location', 'ova-brw' ); ?>
		</label>
		<?php ovabrw_text_input([
			'type'          => 'text',
	...
	<div class="rental_item form-location-field">
		<label for="<?php echo esc_attr( $product->get_meta_key( 'dropoff_location' ) ); ?>">
			<?php esc_html_e( 'Drop-off Location', 'ova-brw' ); ?>
		</label>
		<?php ovabrw_text_input([
			'type'          => 'text',
	...
	<?php if ( ovabrw_array_exists( $extra_hour ) ):
		$extra_time_id = ovabrw_unique_id( 'extra_time' );
	?>
		<div class="rental_item">
			<label for="<?php echo esc_attr( $extra_time_id ); ?>">
				<?php esc_html_e( 'Extra Time', 'ova-brw' ); ?>
			</label>
			<select id="<?php echo esc_attr( $extra_time_id ); ?>" name="<?php echo esc_attr( $product->get_meta_key( 'extra_time' ) ); ?>">
				<option value="">
