...
// Check show resources for booking form
if ( 'yes' !== ovabrw_get_setting( 'booking_form_show_extra_resource', 'yes' ) ) return;
		...
		<div class="ovabrw_resource">
			<?php foreach ( $res_ids as $k => $id ):
				...
				?>
					<div class="item">
						<div class="res-left">
							<label for="<?php echo esc_attr( $field_id ); ?>" class="ovabrw-label-field">
