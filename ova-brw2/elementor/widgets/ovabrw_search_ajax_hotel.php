...
/**
 * Class OVABRW_Widget_Search_Ajax_Hotel
 */
if ( !class_exists( 'OVABRW_Widget_Search_Hotel' ) ) {

	class OVABRW_Widget_Search_Ajax_Hotel extends \Elementor\Widget_Base {
		
		/**
		 * Get widget name
		 */
		public function get_name() {
			return 'ovabrw_search_ajax_hotel';
		}
		...
		public function get_title() {
			return esc_html__( 'Ajax Search Hotel', 'ova-brw' );
		}
		...
		public function get_script_depends() {
			return [ 'ovabrw-search-ajax-hotel' ];
		}
		...
		public function get_style_depends() {
		    ...
		    // Search ajax hotel
		    $style_depends[] = 'ovabrw-search-ajax-hotel';
		...
		protected function register_controls() {
			...
			$this->start_controls_section(
				...
				$this->add_control(
					'search_heading',
					[
						'label' 	=> esc_html__( 'Search Heading', 'ova-brw' ),
						'type' 		=> \Elementor\Controls_Manager::TEXT,
						'default' 	=> esc_html__( 'Search Form', 'ova-brw' ),
					]
				);
				...
				$this->add_control(
					...
					[
						'label'   => esc_html__( 'Form Search Position', 'ova-brw' ),
						'type'    => \Elementor\Controls_Manager::SELECT,
						'default' => 'left',
						'options' => [
							'top' 	=> esc_html__( 'Top', 'ova-brw' ),
							'left' 	=> esc_html__( 'Left', 'ova-brw' ),
							'right' => esc_html__( 'Right', 'ova-brw' )
						],
					]
				);
			...
			$this->start_controls_section(
				...
				$this->add_control(
					...
					[
						...
						'type' 			=> \Elementor\Controls_Manager::TEXT,
						'default' 		=> esc_html__( 'Select Destination', 'ova-brw' ),
					]
				);
				...
				$this->add_control(
					'field_button',
					[
						'label' 		=> esc_html__( 'Label Button', 'ova-brw' ),
						'type' 			=> \Elementor\Controls_Manager::TEXT,
			...
			$this->start_controls_section(
				...
				// Loop
			  	if ( ovabrw_array_exists( $categories ) ) {
				  	...
				  	$product_categories[''] = esc_html__( 'No category found', 'ova-brw' );
			  	}
			...
			$this->start_controls_section(
				...
				[
					'label' => esc_html__( 'Heading', 'ova-brw' ),
				...
				$this->add_group_control(
					...
					[
						...
						'selector' 	=> '.ovabrw-product-search-ajax .product-search-form .search-heading'
					]
				);
				...
				$this->add_control(
					...
					[
						...
						'selectors' => [
							'{{WRAPPER}} .ovabrw-product-search-ajax .product-search-form .search-heading' => 'color: {{VALUE}}',
						],
					]
				);
				...
				$this->add_control(
					...
					[
						...
						'type' 		=> \Elementor\Controls_Manager::COLOR,
						'selectors' => [
							'{{WRAPPER}} .ovabrw-product-search-ajax .product-search-form .search-heading' => 'background-color: {{VALUE}}',
						],
					]
				);
				...
				$this->add_responsive_control(
					...
					[
						...
						'selectors' 	=> [
							'{{WRAPPER}} .ovabrw-product-search-ajax .product-search-form .search-heading' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
						],
					]
				);
				...
				$this->add_responsive_control(
					...
					[
						...
						'size_units' 	=> [ 'px', '%', 'em', 'rem', 'custom' ],
						'selectors' 	=> [
							'{{WRAPPER}} .ovabrw-product-search-ajax .product-search-form .search-heading' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
						],
					]
				);
			...
			$this->start_controls_section(
				...
				$this->add_responsive_control(
					...
					[
						...
						'selectors' 	=> [
							'{{WRAPPER}} .ovabrw-product-search-ajax' => 'max-width: {{SIZE}}{{UNIT}};',
						],
					]
				);
				...
				$this->add_responsive_control(
					...
					[
						...
						'selectors' 	=> [
							'{{WRAPPER}} .ovabrw-product-search-ajax .product-search-form .product-search-content' => 'grid-gap: {{SIZE}}{{UNIT}};',
						],
					]
				);
				...
				$this->add_control(
					...
					[
						...
						'type' 		=> \Elementor\Controls_Manager::COLOR,
						'selectors' => [
							'{{WRAPPER}} .ovabrw-product-search-ajax .product-search-form .product-search-content' => 'background-color: {{VALUE}}',
						],
					]
				);
				...
				$this->add_group_control(
					...
					[
						...
						'selector' 	=> '{{WRAPPER}} .ovabrw-product-search-ajax .product-search-form .product-search-content',
						'separator' => 'before',
					]
				);
				...
				$this->add_responsive_control(
					...
					[
						...
						'size_units' 	=> [ 'px', '%', 'em', 'rem', 'custom' ],
						'selectors' 	=> [
							'{{WRAPPER}} .ovabrw-product-search-ajax .product-search-form .product-search-content' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
						],
					]
				);
				...
				$this->add_responsive_control(
					...
					[
						...
						'size_units' 	=> [ 'px', '%', 'em', 'rem', 'custom' ],
						'selectors' 	=> [
							'{{WRAPPER}} .ovabrw-product-search-ajax .product-search-form .product-search-content' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
						],
					]
				);
			...
			$this->start_controls_section(
				...
				$this->add_group_control(
					...
					[
						...
						'selector' 	=> '{{WRAPPER}} .ovabrw-product-search-ajax .product-search-form .product-search-content .label_search input[type=text], {{WRAPPER}} .ovabrw-product-search-ajax .product-search-form .product-search-content .label_search select'
					]
				);
				...
				$this->add_control(
					...
					[
						...
						'type' 		=> \Elementor\Controls_Manager::COLOR,
						'selectors' => [
							'{{WRAPPER}} .ovabrw-product-search-ajax .product-search-form .product-search-content .label_search input[type=text], {{WRAPPER}} .ovabrw-product-search-ajax .product-search-form .product-search-content .label_search select' => 'color: {{VALUE}}',
						],
					]
				);
				...
				$this->add_control(
					...
					[
						...
						'type' 		=> \Elementor\Controls_Manager::COLOR,
						'selectors' => [
							'{{WRAPPER}} .ovabrw-product-search-ajax .product-search-form .product-search-content .label_search input[type=text]' => 'background-color: {{VALUE}}',
							'{{WRAPPER}} .ovabrw-product-search-ajax .product-search-form .product-search-content .label_search select' => 'background-color: {{VALUE}}',
							'{{WRAPPER}} .ovabrw-product-search-ajax .product-search-content .label_search .ovabrw-guestspicker' => 'background-color: {{VALUE}}',
				...
				$this->add_responsive_control(
					...
					[
						...
						'size_units' 	=> [ 'px', '%', 'em', 'rem', 'custom' ],
						'selectors' 	=> [
							'{{WRAPPER}} .ovabrw-product-search-ajax .product-search-form .product-search-content .label_search input[type=text]' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
							'{{WRAPPER}} .ovabrw-product-search-ajax .product-search-form .product-search-content .label_search select' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
						],
					]
				);
				...
				$this->add_responsive_control(
					...
					[
						...
						'selectors' 	=> [
							'{{WRAPPER}} .ovabrw-product-search-ajax .product-search-form .product-search-content .label_search input[type=text]' => 'height: {{SIZE}}{{UNIT}};',
							'{{WRAPPER}} .ovabrw-product-search-ajax .product-search-form .product-search-content .label_search select' => 'height: {{SIZE}}{{UNIT}};',
						],
					]
				);
				...
				$this->add_control(
					...
					$this->add_group_control(
						...
						[
							...
							'selector' 	=> '{{WRAPPER}} .ovabrw-product-search-ajax .product-search-form .product-search-content .label_search .field-label'
						]
					);
					...
					$this->add_control(
						...
						[
							...
							'type' 		=> \Elementor\Controls_Manager::COLOR,
							'selectors' => [
								'{{WRAPPER}} .ovabrw-product-search-ajax .product-search-form .product-search-content .label_search .field-label' => 'color: {{VALUE}}',
							],
						]
					);
			...
			$this->start_controls_section(
				...
				$this->add_group_control(
					...
					[
						...
						'selector' 	=> '{{WRAPPER}} .ovabrw-product-search-ajax .product-search-form .product-search-content .product-search-submit .ovabrw_btn_submit',
					]
				);
				...
				$this->add_responsive_control(
					...
					[
						...
						'size_units' 	=> [ 'px', '%', 'em', 'rem', 'custom' ],
						'selectors' 	=> [
							'{{WRAPPER}} .ovabrw-product-search-ajax .product-search-form .product-search-content .product-search-submit .ovabrw_btn_submit' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
						],
					]
				);
				...
				$this->add_responsive_control(
					...
					[
						...
						'selectors' 	=> [
							'{{WRAPPER}} .ovabrw-product-search-ajax .product-search-form .product-search-content .product-search-submit .ovabrw_btn_submit' => 'width: {{SIZE}}{{UNIT}};',
						],
					]
				);
				...
				$this->add_responsive_control(
					...
					[
						...
						'selectors' 	=> [
							'{{WRAPPER}} .ovabrw-product-search-ajax .product-search-form .product-search-content .product-search-submit .ovabrw_btn_submit' => 'height: {{SIZE}}{{UNIT}};',
						],
					]
				);
					...
					$this->start_controls_tab(
						...
						$this->add_control(
							...
							[
								...
								'type' 		=> \Elementor\Controls_Manager::COLOR,
								'selectors' => [
									'{{WRAPPER}} .ovabrw-product-search-ajax .product-search-form .product-search-content .product-search-submit .ovabrw_btn_submit' => 'color: {{VALUE}}',
								],
							]
						);
						...
						$this->add_control(
							...
							[
								...
								'type' 		=> \Elementor\Controls_Manager::COLOR,
								'selectors' => [
									'{{WRAPPER}} .ovabrw-product-search-ajax .product-search-form .product-search-content .product-search-submit .ovabrw_btn_submit' => 'background-color: {{VALUE}}',
								],
							]
						);
					...
					$this->start_controls_tab(
						...
						$this->add_control(
							...
							[
								...
								'type' 		=> \Elementor\Controls_Manager::COLOR,
								'selectors' => [
									'{{WRAPPER}} .ovabrw-product-search-ajax .product-search-form .product-search-content .product-search-submit .ovabrw_btn_submit:hover' => 'color: {{VALUE}}',
								],
							]
						);
						...
						$this->add_control(
							...
							[
								...
								'type' 		=> \Elementor\Controls_Manager::COLOR,
								'selectors' => [
									'{{WRAPPER}} .ovabrw-product-search-ajax .product-search-form .product-search-content .product-search-submit .ovabrw_btn_submit:hover' => 'background-color: {{VALUE}}',
								],
							]
						);
		...
		protected function render() {
			...
			ob_start();
			ovabrw_get_template( apply_filters( OVABRW_PREFIX.'widget_template_search_ajax_hotel', 'elementor/ovabrw-search-ajax-hotel.php', $settings ), $settings );
			echo ob_get_clean();
		}
	}

	// Register new widget
	$widgets_manager->register( new OVABRW_Widget_Search_Ajax_Hotel() );
}