...
/**
 * Class OVABRW_Widget_Product_Price
 */
if ( !class_exists( 'OVABRW_Widget_Product_Price' ) ) {

	class OVABRW_Widget_Product_Price extends \Elementor\Widget_Base {
		...
		protected function render() {
			...
			if ( 'modern' === ovabrw_get_meta_data( 'product_template', $settings ) ): ?>
				<div class="ovabrw-modern-product">
					<?php ovabrw_get_template( apply_filters( OVABRW_PREFIX.'widget_template_product_price', 'modern/single/detail/ovabrw-product-price.php', $settings ), $settings ); ?>
				</div>
			<?php else: ?>
				<div class="elementor-price">
					<?php ovabrw_get_template( apply_filters( OVABRW_PREFIX.'widget_template_product_price', 'single/price.php', $settings ), [
	...
	// Register new widget
	$widgets_manager->register( new OVABRW_Widget_Product_Price() );
}