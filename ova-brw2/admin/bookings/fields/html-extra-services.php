...
$service_desc = $this->get_meta_value( 'extra_service_description' );
...
// Get option qtys
$option_qtys = $this->get_meta_value( 'extra_service_option_guest' );

// Get option applicable
$option_applicable = $this->get_meta_value( 'extra_service_option_type' );
	...
	<div class="ovabrw-extra-services">
		...
		<?php if ( 'dropdown' === $display ): ?>
			<div class="ovabrw-service-select">
				<select name="<?php echo esc_attr( $id.'[ovabrw-item-key]' ); ?>" class="<?php echo $required ? 'ovabrw-input-required' : ''; ?><?php echo 'auto' === $choose_guests ? ' auto-guests' : ''; ?>">
					<option value="">
					...
					?>
						<div class="ovabrw-service-guestspicker" data-option="<?php echo esc_attr( $opt_id ); ?>">
							<?php $flag = 0; foreach ( $guest_data as $guest ):
								$opt_guest_name = $id.'_guests[ovabrw-item-key]['.$opt_id.']['.$guest['name'].']';
							...
							<input
								type="hidden"
								name="<?php echo esc_attr( $id.'_max_guests[ovabrw-item-key]['.$opt_id.']' ); ?>"
					...
					<div class="service-item">
						<label for="<?php echo esc_attr( $opt_class ); ?>">
							...
							<input
								...
								name="<?php echo esc_attr( $id ).'[ovabrw-item-key][]'; ?>"
...
if ( ovabrw_array_exists( $hidden_services ) ): ?>
	<input
		type="hidden"
		name="ovabrw-extra-services[ovabrw-item-key]"
