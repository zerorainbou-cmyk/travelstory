...
<div class="wrap ovabrw-guest-info-fields">
	...
	<div id="ovabrw-guest-info-description">
		<p>
			<?php printf( esc_html__( 'By default, all these fields will be applied to all guests. However, you can select specific fields for each guest in the %s tab.', 'ova-brw' ), '<a href="'.esc_url( admin_url('/admin.php?page=wc-settings&tab=ova_brw&section=guests')).'">'.esc_html__( 'Guests', 'ova-brw' ).'</a>' ); ?>
		</p>
	</div>
	<div class="heading">
