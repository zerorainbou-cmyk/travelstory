...
/**
 * Class OVADES_Google_Maps_Fields
 */
if ( !class_exists( 'OVADES_Google_Maps_Fields' ) ) {
	...
	class OVADES_Google_Maps_Fields {
		...
		public function __construct() {
			add_filter( 'cmb2_render_pw_map', [ $this, 'render_pw_map' ], 10, 5 );
			add_filter( 'cmb2_sanitize_pw_map', [ $this, 'sanitize_pw_map' ], 10, 4 );
			add_filter( 'pw_google_api_key', [ $this, 'google_api_key_constant' ] );
		}
		...
		public function render_pw_map( $field, $field_escaped_value, $field_object_id, $field_object_type, $field_type_object ) {
			...
			echo $field_type_object->input([
				'type' 	=> 'hidden',
				'name' 	=> $field->args('_name') . '_zoom',
				'value' => get_option( 'ova_brw_zoom_map_default', 17 ),
				'class' => 'pw-map-zoom',
				'desc' 	=> ''
			]);
			echo $field_type_object->input([
